// ignore_for_file: sort_child_properties_last, non_constant_identifier_names, use_function_type_syntax_for_parameters
...
// 使用GetX实现
// class TabPage extends GetView<GetTabController> {
...
//                 ],
//                 tabBarView: GFTabBarView(
//                   controller: controller.tabControllerSmall,
//                   children: [
//                     Container(color: Colors.teal),
//                     Container(color: Colors.red),
//                     Container(color: Colors.black45),
...
//               //另一种段落样式的tab
//               GFSegmentTabs(
//                 tabController: controller.tabControllerSmall,
//                 length: 3,
//                 tabs: const [
//                   Text("Tab1"),
//                   Text("Tab2"),
...
// //一个tabcontroller可以实现GetSingleTickerProviderStateMixin
// //如果有多个tabController则需要实现 GetTickerProviderStateMixin
